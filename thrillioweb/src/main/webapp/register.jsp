...
function onValidate(){
	 ...
	 if(password!=repassword){
		 ...
		 alert("Password cannot start with special character");
		 return false;
	 }
	 else{
		 return true;
...
<body>
	...
	<div
		...
		<b> <a href="<%=request.getContextPath()%>/login.jsp"
			...
			<table>
				...
				<tr>
					...
					<td><input type="radio" name="gender" value="0"> Male
						...
						type="radio" name="gender" value="2"> Others</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="password" name="password" required
						minlength="6" maxlength="20"><br></td>
				</tr>
				<tr>

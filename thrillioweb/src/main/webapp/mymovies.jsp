				...
				<c:forEach var="movie" items="${movies}">
					<tr>
						...
						<br> Genre: <span style="color: #B13100;">${movie.genre.getName()}</span>
							<br>
						<br> <a
							href="<%=request.getContextPath()%>/auth/login/bookmark/movies/unsave?mid=${movie.id}"
							style="font-size: 18px; color: #0058A6; font-weight: bold; text-decoration: none">Unsave</a>
						</td>
					</tr>
					<tr>
						<td>&nbsp;</td>
